  ...
  return (
    <main className="linen min-h-screen bg-background">
      ...
      <div className="mx-auto w-full max-w-3xl px-4 py-10 lg:px-8">
        <div className="mb-6 rounded-xl border border-gold/40 bg-accent/30 px-4 py-3 text-sm text-muted-foreground">
          Draft — pending review by a lawyer before this is relied on as final. Bracketed items need
          to be filled in with real registration details.
        </div>
