...
export const Route = createFileRoute("/cookies")({
  head: () => ({ meta: [{ title: "Cookie Notice — Jaylor" }] }),
  component: Cookies,
});
    ...
    <LegalLayout title="Cookie Notice" lastUpdated="20 September 2026">
      <section>
        ...
        <p>
          ...
          (like light or dark mode). We don&apos;t use advertising or cross-site tracking cookies.
        </p>
      </section>
      ...
      <section>
        ...
        <ul>
          ...
          <li>
            ...
            small install-prompt/visit counter for the installable app experience.
          </li>
          <li>
